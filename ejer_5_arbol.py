...
value_to_delete = "Roctor Strange"
delete_value, extra_info = tree.delete_node(value_to_delete)  #e
...
print()
pos_doc = tree.search("Doctor Strange")
if pos_doc is not None:
      print(f"nombre: {pos_doc.value}, heroe: {pos_doc.other_value}")
