...
class BinaryTree:
    ...
    def double_rotation(self, root, control):
        if control:
            root.left = self.simple_rotation(root.left, False) #se llama a rotacion simple en el subarbol izquierdo, false ya que es rota a la izquierda
            root = self.simple_rotation(root, True) # se llama a rotacion simple en la raiz, true ya que es hacia la derecha
        else:
